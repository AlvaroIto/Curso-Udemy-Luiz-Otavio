...
CAMINHO_ZIP_DIR = CAMINHO_RAIZ / 'aula8_diretorio_zip'
CAMINHO_COMPACTADO = CAMINHO_RAIZ / 'aula8_compactado.zip'
CAMINHO_DESCOMPACTADO = CAMINHO_RAIZ / 'aula8_descompactado'
...
#Criar pasta compactada e adicionando arquivos
